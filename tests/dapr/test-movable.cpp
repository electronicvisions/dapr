...
struct DummyMovable : public dapr::Movable<DummyMovable>
{
	virtual ~DummyMovable() {}
	DummyMovable(DummyMovable&&) = default;
	DummyMovable(DummyMovable const&) = default;
	DummyMovable& operator=(DummyMovable&&) = default;
	DummyMovable& operator=(DummyMovable const&) = default;
